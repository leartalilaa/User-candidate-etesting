                ...
                return {
                    ...
                    link: function(scope, elem, attr, API) {
                        ...
                        function onVideoReady() {
                            ...
                            /* update player state if onStateChange is not working */
                            function getState() {
                            ...
                            var updateState = setInterval(getState, 1000);
                        ...
                        //to show the control bar on IE
                        angular.element(document).ready(function () {
                            var iframeUrl = angular.element(ytplayer.getIframe()).attr('src');
                            angular.element(ytplayer.getIframe()).attr('src', iframeUrl + '&wmode=transparent');
                        });
